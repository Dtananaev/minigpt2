...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, block_size, n_head, head_size, n_embd, dropout):
        super().__init__()
        self.heads = nn.ModuleList([Head(block_size=block_size, n_embd=n_embd, head_size=head_size, dropout=dropout) for _ in range(n_head)])
